# Assembly Lab — Demo Script and Shot List
...
|---|---|---|
| 0:00–0:12 | Open `/webmcp`; show the hero and the browser-agent request card. | “Most browser agents work alone. Assembly Lab lets one browser agent assemble and coordinate an entire specialist crew.” |
...
| 2:27–2:35 | End on the hero and project name. | “Assembly Lab turns the browser agent from a solitary operator into a transparent orchestrator of collective intelligence.” |
